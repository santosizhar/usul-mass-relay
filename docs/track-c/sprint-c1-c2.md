...
Artifacts:
- Agent Playbook TypeScript interface in `packages/agent-playbook/src/agent-playbook.ts`.
- Agent Playbook JSON schema in `packages/agent-playbook/src/agent-playbook.schema.json`.
...
Artifacts:
- Governance policy TypeScript interface in `packages/governance-policy/src/governance-policy.ts`.
- Governance policy JSON schema in `packages/governance-policy/src/governance-policy.schema.json`.
